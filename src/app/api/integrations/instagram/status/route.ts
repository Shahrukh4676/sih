...
export async function GET(req: NextRequest) {
  try {
    ...
    const data = await InstagramService.getInstagramConnection(organizationId, userId);
    ...
    const connectedRes = NextResponse.json({
      ...
      user: {
        ...
        avatar: connection.profilePictureUrl,
      },
    ...
    console.error("[Instagram Status] Error checking status:", errorObj);
