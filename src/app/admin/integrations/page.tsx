...
const initialIntegrations: IntegrationItem[] = [
  ...
  },
  {
    ...
    status: "CONNECTED",
    version: "Internal",
    details: "Native in-process state machine with tenant isolation, approval gating, and direct channel dispatch.",
    account: "Internal Orchestration",
    verified: true,
  },
  {
    id: "whatsapp",
  ...
  },
  {
    ...
    status: "NOT_CONNECTED",
    version: "v2",
    details: "Thread formatting and automated thread publishing. Coming Soon.",
    account: "Not Connected / Coming Soon",
    verified: false,
  },
  {
    id: "instagram",
    ...
    status: "NOT_CONNECTED",
    version: "v21.0",
    details: "Visual carousel publishing and story alerts. Coming Soon.",
    account: "Not Connected / Coming Soon",
    verified: false,
  },
  {
